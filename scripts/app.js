...
const soundsScore = [new Audio("sounds/0_points.mp3"), new Audio("sounds/1_points.mp3"), new Audio("sounds/2_points.mp3"), new Audio("sounds/3_points.mp3"), new Audio("sounds/4_points.mp3"), new Audio("sounds/5_points.mp3")];
